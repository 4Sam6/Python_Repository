...
g = sns.catplot(
    data=bird_melted, kind="bar",
    x="Type of Bird", y="Count", hue="Gender",
    errorbar= None, palette="dark", alpha=.6, height=6
)

g.set_axis_labels("", "Amount Seen")
g.legend.set_title("")

plt.savefig(f"{OUTPUT_DIR}/birdgroupedbar{current_date}.png")# This OUTPUT_DIR was made for use with .gitingore 
